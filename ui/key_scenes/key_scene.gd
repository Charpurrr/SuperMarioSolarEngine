...
##[br]If you have something to finish before you leave, make sure to put it here! 
##[br]Remember also to use the "signal" message to tell the transition manager to await a certain signal before continuing.
